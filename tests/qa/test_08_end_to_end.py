...
SECTIONS = [
    ...
    ("s4_climax",  "Climax", 38, 50, "This is not science fiction. Streamdex is an open-source platform that orchestrates AI tools into a complete video pipeline."),
