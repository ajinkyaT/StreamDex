...
**This file** teaches how Streamdex uses Remotion — which compositions map to pipeline
...
| Streamdex Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| Streamdex Profile | Remotion Config |
|--------------------|-----------------|
