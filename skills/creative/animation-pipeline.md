...
| **Web/explainer standard** | 30 | Default for YouTube/web video. Streamdex default. |
...
**Streamdex default:** 30fps. Render Manim at 60fps and transcode to 30fps for smoother motion at delivery frame rate.
...
## Applying to Streamdex

When building animation/motion graphics content:

1. **Render at 30fps** (Streamdex default) — Manim at 60fps, transcode down
