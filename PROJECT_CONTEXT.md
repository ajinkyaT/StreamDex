# Streamdex - Shared Project Context
...
Streamdex is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How Streamdex uses them" (project conventions)
